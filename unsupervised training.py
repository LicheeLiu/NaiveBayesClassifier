...
def train_unsupervised(dataset, label_num):
...
def evaluate_unsupervised(originalLabel, predict_result_set):
	maxCorrect = 0
	finalPredictResult = []
	#among all the permutation of corresponding label names. The one with the highest accuracy is the correct label names.
...
def main():
	...
	for filename in filenames:
		...
		dataset = train_unsupervised(dataset, label_num)
